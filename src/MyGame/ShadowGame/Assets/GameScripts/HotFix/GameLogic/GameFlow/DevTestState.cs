...
namespace GameLogic
{
    public class DevTestState : GameFlowState
    {
        protected override void OnEnter(IFsm<IFsmModule> fsm)
        {
            ...
            // V3.0.1 dp8 candidate (2026-06-15): DevTestState [main-menu] mode HasSpike list 加 S6-16 = 9 spike，
            //   详 production/epics/vs-chapter-1/story-007-shadowmatch-production-wire.md §V3.0.1 Watch List Hooks。
            // V3.0.1 dp8 candidate (2026-06-15): DevTestState [main-menu] mode HasSpike list 加 S6-17 = 10 spike，
            //   详 production/epics/vs-chapter-1/story-008-end-to-end-smoke-replay.md §V3.0.1 Watch List Hooks。
            if (DevTest.DevBootstrap.HasSpike("S5-02") || DevTest.DevBootstrap.HasSpike("S6-07") ||
                ...
                DevTest.DevBootstrap.HasSpike("S6-16") || DevTest.DevBootstrap.HasSpike("S6-17"))
            {
                Log.Info("[GameFlow] [main-menu] 检测到 main menu spike (S5-02/…/S6-17) — Button click 模式或 spike 自驱或用户手动驱动");
